...
```sh
sudo wget https://binaries.sonarsource.com/Distribution/sonarqube/sonarqube-10.0.zip
sudo unzip sonarqube-10.0.zip
sudo rm -rf sonarqube-10.0.zip
sudo mv sonarqube-10.0. sonarqube
```
